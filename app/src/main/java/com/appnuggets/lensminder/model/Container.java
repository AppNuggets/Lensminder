...
public class Container {
    ...
    public Container(Date expirationDate, Date openDate, Integer duration, String name){
    ...
    /* Returns max number of days resource can be used for*/
    public Integer getDuration() {
        return duration;
    }

    /* Returns real number of days resource can be used for. Negative value can be returned
     * when prolonged use occurs
     */
    ...
    /*Returns number of days resource has been used for*/
